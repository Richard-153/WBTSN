# ================================
# 文件 2/2: test_correction_gan.py (改成和 train_correction_gan.py 配套，并计算平均 PSNR/SSIM)
# ================================
...
from train8 import CorrectionNet
...
def test_correction_denoising():
    ...
    # 加载 CorrectionNet
    correction_model = CorrectionNet().to(device)
        ...
        for noisy_imgs, filenames in tqdm(test_loader, desc='Testing'):
            ...
            for i in range(final_outputs.shape[0]):
                ...
                if os.path.exists(gt_path):
                    ...
                    psnr_list.append(compare_psnr(gt_img, out_tensor))
